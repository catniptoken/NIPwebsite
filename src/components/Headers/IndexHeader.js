...
function IndexHeader() {
  ...
  return (
    <>
      <div className="page-header clear-filter" filter-color="yellow" id="indexHeaderSectionID">
        <div
        ...
        <Container>
          <div className="content-center brand">
            <img
              alt="..."
              className="n-logo"
              src={require("newAssets/CatNIPlogoIconBig.png").default}
            ></img>
            <h1 className="h1-seo">Welcome to CatNIP!</h1>
            <h3>CatNIP is a new Cryptocurrency with an NFT Battler game.</h3>
          </div>
